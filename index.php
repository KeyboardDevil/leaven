    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <h3>Brewery Hours:</h3>
          <ul>
            <li>Monday - Thursday 12:00 - 10:00 PM</li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <iframe width="70%" height="500" src="https://dsdlink.com/aspx1/Home?DashboardID=175197&SupplierID=35116&BrandID=332367" frameborder="0" allowfullscreen  ></iframe>
        </div>
      </div>
    </div>
  </section>
